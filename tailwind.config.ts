    ...
    extend: {
      ...
      boxShadow: {
        ...
        /* The home screen's one elevation, straight from the Figma file.
           Behind a token because the value is theme-dependent: the design's
           shadow is nearly white, which reads as a halo on a dark page, so
           .dark resolves it to `none`. See --shadow-figma in index.css. */
        "figma": "var(--shadow-figma)",
      },
    },
  },
